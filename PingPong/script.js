...
// const
const thisBar1 = "Player-1";
const thisBar2 = "Player-2";
const storeName = "abc";
...
(function(){
    ...
    if(whichBar=="null" || highScore==="null"){
        alert("Hello.. First Game");
        highScore=0;
        whichBar=thisBar1;
    }
    else{
        alert(whichBar + " has maximum score of " + highScore*50);
    }
    gameReset(whichBar);
})();
...
function dataStoring(scoreObtained,winningBar){
    ...
    alert(winningBar+" wins, Score is "+(scoreObtained*50)+"  Max Score is : " + (highScore*50));
}